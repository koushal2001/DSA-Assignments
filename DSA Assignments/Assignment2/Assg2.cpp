...
public:
	void post();			//Display postfix expression
	void post_prefix();		//Display prefix expression
	string reverse(string);	//Reverse the string
	void brackets();		//Change brackets
	void conversion();		//expression conversion
	int precedence(char);	//setting precedence
	int associativity(char);//setting associativity
